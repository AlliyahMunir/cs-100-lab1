...
TEST(EchoTest, DisneyGreeting) {
    long string* test_val[10]; test_val[0] = "./c-echo"; 
    test_val[1] = "Welcome"; test_val[2] = "Back";
    test_val[3] = "to"; test_val[4] = "Disney,"; 
    test_val[5] = "Where"; test_val[6] = "Your";
    test_val[7] = "Dreams"; test_val[8] = "Come";
    test_val[9] = "True!";

    EXPECT_EQ("Welcome Back to Disney, Where Your Dreams Come True!", echo(10,test_val));
}
...
TEST(EchoTest, Alphabet) {
    long char* test_val[9]; test_val[0] = "./c-echo"; 
